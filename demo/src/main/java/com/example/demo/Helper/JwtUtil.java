...
public class JwtUtil {
    ...
    private static final long JWT_TOKEN_VALID = 5 * 60 * 60000;
    private String secret = "Raju123";
    ...
    public <T, Claims> T getClaimFromToken(String token, Function<Claims,T> claimsResolver){
